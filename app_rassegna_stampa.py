...
if not is_mobile():
    st.warning("🔒 Questa applicazione è disponibile solo da smartphone.")
    st.markdown("""
        <p style="font-size: 18px; color: #444;">
            Per accedere alla rassegna stampa da desktop, <br>
            inquadra questo QR code dal tuo telefono:
        </p>
