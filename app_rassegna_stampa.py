...
<div class="blocker desktop-only">
...
# Verifica se l'utente è su desktop (solo lato server, non affidabile al 100%)
is_desktop = st.experimental_get_query_params().get("is_desktop", ["false"])[0] == "true"

# Tentativo di rilevamento lato client (aggiungendo JS)
js_check_desktop = """
<script>
function isDesktop() {
...
"""
st.markdown(js_check_desktop, unsafe_allow_html=True)
